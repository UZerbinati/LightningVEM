function [K_global, M_global, f_global,domainMesh] = elasticity_assembly(domainMesh, matProps, f1, f2, k)
...
%% MEMORY ALLOCATION
siz = 2 * domainMesh.nvertex ;                                                                  %Size of the linear system     
...
for i = 1:domainMesh.npolygon
    ...
    [K_loc{i}, M_loc{i}, f_loc{i}, polygons{i}] = elasticity_element(vertex, matProps, f1 ,f2, k);                %Assembly local stiffness matrix and load term
...
for i = 1:domainMesh.npolygon
    ...
    local_dofs = [local_vertex; local_vertex + domainMesh.nvertex];
