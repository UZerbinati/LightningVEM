function [K_local, M_loc, f_local, polygon] = elasticity_element(vertex, matProps, f1, f2, k)
...
p_quad = polygon_quadrature(polygon, k+2);                                                           %Construct the quadrature on the polygon
